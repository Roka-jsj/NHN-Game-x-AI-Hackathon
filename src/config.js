...
//
// 값을 크게 잡으면 **아군 전열 뒤에 선 궁수가 통째로 무력해진다.**
// 유닛 간격이 21 이므로 두 칸 뒤(42)에 선 궁수는 쏠 수 있어야 한다.
// 30 이면 코앞(검사 사거리 22)만 막고 제 자리에서 쏘는 것은 막지 않는다.
export const U_MIN_RANGE = [0, 0, 30, 0, 0, 90];
